...
python trainVDRParser.py -p data/emnlp2013/ -m mst -k 5 -d non-proj -s 10 -f true -i true

# Predict the VDRs for the test splits.
python testVDRParser.py -p data/emnlp2013/ -m mst -k 5 -d non-proj -s 10 -f true -i true
