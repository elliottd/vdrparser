...
public class DependencyPipe
{
    ...
    protected final DependencyInstance nextInstance() throws IOException
    {
        ...
        instance.setFeatureVector(createFeatureVector(instance, depReader.getCount()));
    ...
    private final void createAlphabet(String file) throws IOException
    {
        ...
        while (instance != null)
        {
            ...
            createFeatureVector(instance, cnt);
            cnt++;
    ...
    public FeatureVector createFeatureVector(DependencyInstance instance, int count)
    {
