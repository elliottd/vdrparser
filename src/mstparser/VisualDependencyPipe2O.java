...
public class VisualDependencyPipe2O extends DependencyPipeVisual
{

    public VisualDependencyPipe2O(ParserOptions options) throws IOException
    {
        super(options);
    }
        ...
        for (int i = 0; i < instanceLength; i++)
        {
          ...
          for (int j = 0; j < instanceLength; j++)
          {
              ...
              if (heads[j] == i)
              {
                  ...
                  addSiblingFeatures(instance, i, j, prev == i, fv);
                  prev = j;
              }
          }                     
//            // right children
...
//        add("CH_WPAIRB=" + ch1_pos + "_" + ch2_word + "_" + dir, 1.0, fv);
        ...
        add("ACH_WPAIR=" + ch1_word + "_" + ch2_word, fv);
